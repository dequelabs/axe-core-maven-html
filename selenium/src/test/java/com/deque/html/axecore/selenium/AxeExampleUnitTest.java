...
public class AxeExampleUnitTest {
  ...
  public void testAccessibility() throws IOException, OperationNotSupportedException {
    ...
    Assert.assertFalse(
        getReadableAxeResults(ResultType.Violations.getKey(), webDriver, violations));
  ...
  public void testAccessibilityWithSkipFrames() throws IOException, OperationNotSupportedException {
    ...
    AxeReporter.writeResultsToJsonFile(
        "src/test/java/results/testAccessibilityWithSkipFrames", result);
    Assert.assertFalse(
        getReadableAxeResults(ResultType.Violations.getKey(), webDriver, violations));
    AxeReporter.writeResultsToTextFile(
  ...
  public void testInjectsIntoNestedIframes() throws IOException, OperationNotSupportedException {
    ...
    AxeReporter.writeResultsToJsonFile(
        "src/test/java/results/testInjectsIntoNestedIframes", result);

    Assert.assertTrue(getReadableAxeResults(ResultType.Violations.getKey(), webDriver, violations));
    AxeReporter.writeResultsToTextFile(
        "src/test/java/results/testInjectsIntoNestedIframes", AxeReporter.getAxeResultString());
  ...
  public void testInjectsIntoNestedFrames() throws IOException, OperationNotSupportedException {
    ...
    Assert.assertTrue(getReadableAxeResults(ResultType.Violations.getKey(), webDriver, violations));
    AxeReporter.writeResultsToTextFile(
        "src/test/java/results/testInjectsIntoNestedFrames", AxeReporter.getAxeResultString());
  ...
  public void testAccessibilityWithOptions() throws IOException, OperationNotSupportedException {
    ...
    Assert.assertEquals("No violations found", 0, violations.size());
    AxeReporter.writeResultsToJsonFile(
        "src/test/java/results/testAccessibilityWithOptions", result);
    Assert.assertFalse(
        getReadableAxeResults(ResultType.Violations.getKey(), webDriver, violations));
    AxeReporter.writeResultsToTextFile(
  ...
  public void testCustomTimeout() throws IOException, OperationNotSupportedException {
    ...
    try {
      ...
      Assert.assertTrue(
          "Did not error with timeout message",
          msg.contains("1 seconds") || msg.contains("timeout"));
      didTimeout = true;
    }
  ...
  public void testAccessibilityWithSelector() throws IOException, OperationNotSupportedException {
    ...
    Assert.assertEquals("No violations found", 0, violations.size());
    AxeReporter.writeResultsToJsonFile(
        "src/test/java/results/testAccessibilityWithSelector", result);
    Assert.assertFalse(
        getReadableAxeResults(ResultType.Violations.getKey(), webDriver, violations));
    AxeReporter.writeResultsToTextFile(
  ...
  public void testAccessibilityWithSelectors() throws IOException, OperationNotSupportedException {
    ...
    Assert.assertEquals("No violations found", 0, violations.size());
    AxeReporter.writeResultsToJsonFile(
        "src/test/java/results/testAccessibilityWithSelectors", result);
    Assert.assertFalse(
        getReadableAxeResults(ResultType.Violations.getKey(), webDriver, violations));
    AxeReporter.writeResultsToTextFile(
  ...
  public void testAccessibilityWithIncludesAndExcludes()
    ...
    AxeReporter.writeResultsToJsonFile(
        "src/test/java/results/testAccessibilityWithIncludesAndExcludes", result);
    Assert.assertTrue(getReadableAxeResults(ResultType.Violations.getKey(), webDriver, violations));
    AxeReporter.writeResultsToTextFile(
        "src/test/java/results/testAccessibilityWithIncludesAndExcludes",
  ...
  public void testAccessibilityWithWebElement() throws IOException, OperationNotSupportedException {
    ...
    Assert.assertEquals("No violations found", 0, violations.size());
    AxeReporter.writeResultsToJsonFile(
        "src/test/java/results/testAccessibilityWithWebElement", result);
    Assert.assertFalse(
        getReadableAxeResults(ResultType.Violations.getKey(), webDriver, violations));
    AxeReporter.writeResultsToTextFile(
  ...
  public void testAccessibilityWithWebElements()
    ...
    AxeReporter.writeResultsToJsonFile(
        "src/test/java/results/testAccessibilityWithWebElements", result);
    Assert.assertTrue(getReadableAxeResults(ResultType.Violations.getKey(), webDriver, violations));
    AxeReporter.writeResultsToTextFile(
  ...
  public void testAccessibilityWithShadowElement()
    ...
    AxeReporter.writeResultsToJsonFile(
        "src/test/java/results/testAccessibilityWithShadowElement", result);
    Assert.assertTrue(getReadableAxeResults(ResultType.Violations.getKey(), webDriver, violations));
    AxeReporter.writeResultsToTextFile(
        "src/test/java/results/testAccessibilityWithShadowElement",
        AxeReporter.getAxeResultString());
  ...
  public void testAccessibilityWithFewInclude() throws IOException, OperationNotSupportedException {
    ...
    Assert.assertEquals("No violations found", 0, violations.size());
    AxeReporter.writeResultsToJsonFile(
        "src/test/java/results/testAccessibilityWithFewInclude", result);
    Assert.assertFalse(
        getReadableAxeResults(ResultType.Violations.getKey(), webDriver, violations));
    AxeReporter.writeResultsToTextFile(
  ...
  public void testAccessibilityWithIncludesAndExcludesWithViolation()
    ...
    Assert.assertTrue(getReadableAxeResults(ResultType.Violations.getKey(), webDriver, violations));
    AxeReporter.writeResultsToTextFile(
        "src/test/java/results/testAccessibilityWithIncludesAndExcludesWithViolation",
        AxeReporter.getAxeResultString());
    Assert.assertEquals("No violations found", 2, violations.size());

    File jsonFile =
        new File(
            "src/test/java/results/testAccessibilityWithIncludesAndExcludesWithViolation.json");
    File txtFile =
        new File("src/test/java/results/testAccessibilityWithIncludesAndExcludesWithViolation.txt");
    Assert.assertTrue("Json file was not deleted.", jsonFile.delete());
    Assert.assertTrue("Txt file was not deleted.", txtFile.delete());
  }
