...
public final class WebDriverExtensions {
  ...
  public static String openAboutBlank(final WebDriver webDriver) {
    ...
    try {
      ...
      throw new RuntimeException("switchToWindow failed. Are you using updated browser drivers? Please check out https://github.com/dequelabs/axe-core-maven-html/error-handling.md", e);
    }
